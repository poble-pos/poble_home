  ...
  sections: [
    {
      ...
      order: 0,
      content: {
        title: "Minus the Clutter, Plus the Speed",
        description:
          "The lightweight POS built for Aussie venues. <br />Fast to learn, easy to run — even during the rush.<br />Turn your iPad into a pro POS instantly.*",
    ...
    },
    {
      ...
      content: {
        ...
        subtitle:
          "Built for the reality of your day. With poble, we remove the friction from your counter, so your team stays focused on every customer and every cup.",
        feature1_title: "The Balancing Act",
        feature1_desc:
          "End your day in seconds. Automated reconciliation ensures your dockets and payments always match, without the manual grind.",
    ...
    },
    {
      ...
      content: {
        ...
        feature1_desc:
          "Manage menus, prices, and staff permissions directly on the POS. No separate back office, no delays — changes sync smoothly across your store.",
        feature2_title: "High-Speed|Order Flow",
        feature2_collapsed:
          "Built for peak-hour service. Orders move fast without slowing your team.",
        feature2_desc:
          "Designed for busy service counters. Takeaway, dine-in, and phone orders flow smoothly so staff stay focused on service, not the screen.",
        feature3_title: "Aussie Payments|Tyro Ready",
        feature3_collapsed:
          "Native EFTPOS integration for Australian venues. No double handling.",
        feature3_desc:
          "Integrated with Tyro and Linkly for a direct terminal workflow. The amount is sent straight from the iPad to EFTPOS, reducing errors and speeding up checkout.",
        feature4_title: "Instant Menu|Live Sync",
        feature4_collapsed: "Edit menus instantly. Updates apply right away.",
        feature4_desc:
          "Update prices or mark items sold out directly on the POS. All terminals stay aligned in real time, without reloading or manual refresh.",
        feature5_title: "Smart Operations|Table & KDS",
        feature5_collapsed:
          "Clear table layouts and kitchen display support. Keep service flowing.",
        feature5_desc:
          "Visual table layouts help manage dine-in service at a glance. Orders are sent straight to the kitchen display, reducing missed tickets and confusion.",
        feature6_title: "Customer Growth|CRM & Online",
        feature6_collapsed:
          "Built-in loyalty and online ordering to support repeat customers.",
        feature6_desc:
          "Reward regulars with points and vouchers. Online orders flow directly into the POS, without third-party complexity.",
        feature1_image:
        ...
        feature4_image:
          "https://images.unsplash.com/photo-1556741533-974f8e62a92d?auto=format&fit=crop&q=80&w=800",
        feature5_image:
          "https://images.unsplash.com/photo-1556742502-ec7c0e9f34b1?auto=format&fit=crop&q=80&w=800",
        feature6_image:
          "https://images.unsplash.com/photo-1556745753-b2904692b3cd?auto=format&fit=crop&q=80&w=800",
      },
    },
    {
      id: "pricing",
      ...
      content: {
        ...
        carousel_items: [
          ...
          },
          {
            ...
            description:
              "Simple, real-time reporting on your sales and staff performance. Accessible from anywhere.",
            images: [
          ...
          },
          {
            ...
            description:
              "Easily manage your menu across all devices. Sync categories, items, and prices instantly.",
            images: [
          ...
          },
          {
            ...
            description:
              "Give your customers a clear view of their order as it hits the screen, reducing errors and increasing transparency.",
            images: [
    ...
    },
    {
      ...
      content: {
        ...
        quote1_text:
          "In the Sydney coffee scene, speed is everything. Poble allows us to power through the morning rush without missing a beat.",
        ...
        quote3_text:
          "We use two POS terminals to handle entry ticketing and café orders. The sync is instant, and the system easily manages volume.",
    ...
    },
    {
      ...
      content: {
        ...
        description:
          "poble runs on the world's most stable tablet platform. Pair it with industry-standard printers for a bulletproof counter setup.",
        images: [
        ...
        feature1_desc:
          "Compatible with iPad (7th Gen) and later. No need for proprietary, expensive touchscreens.",
        feature2_title: "Industry Standard",
        feature2_desc:
          "We support proven thermal printers like POSBANK & Epson for bulletproof reliability.",
      },
    },
    {
      id: "integrations",
      ...
      content: {
        ...
        description:
          "We're expanding our network to include the tools you rely on most. Seamless syncing with Australia's most trusted platforms.",
      },
    },
    {
      id: "faq",
      ...
      content: {
        ...
        description:
          "Getting started is simple with our guided installation process. And once you're live, our expert team is available 7 days a week.",
        faq: [
          {
            q: "How long does setup take?",
            a: "Most venues are up and running within 24 hours. If you have an existing menu, we can import it for you instantly.",
            visible: true,
          },
          {
            q: "Do I need special hardware?",
            a: "Poble is designed to run on any modern iPad (7th Gen or later). We also support standard thermal printers and cash drawers.",
            visible: true,
          },
          {
            q: "Is there a long-term contract?",
            a: "No. We believe in our product, so we offer simple month-to-month plans. You can cancel at any time without penalty.",
            visible: true,
          },
        ],
      },
    ...
    },
    {
      ...
      content: {
        ...
        subtitle:
          "Join the growing network of Australian venues who have swapped complex, slow systems for the speed of poble.",
