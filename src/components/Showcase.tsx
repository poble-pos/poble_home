...
export const Showcase: React.FC = () => {
  ...
  const config =
    siteContent.sections.find((s) => s.id === "showcase")?.content || {};
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-[0.85fr_1.15fr] gap-12 lg:gap-24 items-center">
            ...
            <div className="flex justify-center gap-2 md:gap-6 mt-8 md:mt-12 relative z-20 items-center">
              ...
              {PREVIEW_IMAGES.map((src, i) => (
                ...
                >
                  ...
                  {isPobleGallery && (
                    <div
                      className={`absolute inset-0 flex items-center justify-center transition-all duration-500 bg-black/30 backdrop-blur-[2px]
          ...
          <div className="order-1 lg:order-2">
            <p className="text-poble-gold font-black uppercase tracking-[0.3em] text-xs mb-6 block">
            ...
            <div className="grid grid-cols-2 gap-12 font-sans">
              <div>
                <h4 className="font-black text-white text-lg mb-4 tracking-tight leading-tight">
                  {config.feature1_title || "Universal iPad Support"}
                </h4>
                <p className="text-slate-400 text-base font-bold leading-relaxed tracking-tight">
              ...
              <div>
                <h4 className="font-black text-white text-lg mb-4 tracking-tight leading-tight">
                  {config.feature2_title || "Industry Standard"}
                </h4>
                <p className="text-slate-400 text-base font-bold leading-relaxed tracking-tight">
            ...
            <div className="mt-16 pt-12 border-t border-white/10 flex flex-col sm:flex-row items-start sm:items-center gap-8 justify-between">
              ...
              >
                ...
                <div className="bg-poble-charcoal/10 rounded-full p-1 group-hover:bg-poble-charcoal/20 transition-colors">
                  <svg
                    className="w-4 h-4 text-poble-charcoal group-hover:translate-x-1 transition-transform"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
