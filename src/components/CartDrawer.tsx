      ...
      <div className="relative w-[85vw] md:w-full max-w-md bg-white h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-500 border-l border-slate-100">
        <div className="p-8 flex items-center justify-between border-b border-slate-50">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-black text-poble-charcoal tracking-tighter">
              Your Cart
            </h2>
          </div>
          <button
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8">
          {items.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center space-y-6">
              <div>
                <h3 className="text-xl font-black text-poble-charcoal mb-2">
                  Your cart is empty.
                </h3>
              ...
              >
                ...
                <div className="flex-1 flex flex-col justify-center">
                  <div className="flex justify-between items-start mb-1">
                    <h3 className="font-black text-poble-charcoal tracking-tight leading-tight">
                      {item.name}
                    </h3>
                    <button
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-3 bg-slate-50 rounded-full p-1 border border-slate-100">
                      ...
                      <span className="text-sm font-black w-4 text-center text-poble-charcoal">
                        {item.quantity}
                      </span>
                      <button
                        onClick={() =>
        ...
        {items.length > 0 && (
          <div className="p-8 border-t border-slate-50 bg-slate-50/30">
            <div className="flex justify-between items-center mb-8">
              ...
              <span className="text-3xl font-black text-poble-charcoal tracking-tighter">
                ${cartTotal.toFixed(2)}
              </span>
            </div>
