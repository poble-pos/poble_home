        ...
        <div className="p-6 flex flex-col">
          ...
          <div className="flex items-center justify-between mt-auto">
            ...
            <Button
              ...
              className="text-white px-4 py-2 rounded-lg transition-all duration-200 flex items-center space-x-2 hover:shadow-md hover:cursor-pointer bg-slate-900 hover:bg-slate-800"
            >
